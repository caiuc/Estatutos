...
\begin{document}
	...
	\section{Elecciones, requisitos y sanciones}\label{elecciones}
			...
			\begin{enumerate}
				...
				\item En el caso de alumnos de pregrado:
					\begin{enumerate}
						...
						El organismo oficial de validación es la Dirección de Pregrado de la Escuela de Ingeniería.
					\end{enumerate}
				\item En el caso de alumnos de postgrado:
					\begin{enumerate}
						...
						El organismo oficial de validación es la Dirección de Postgrado de la Escuela de Ingeniería.
					\end{enumerate}
				...
				Esta norma tiene por objetivo que ningún miembro del Comité Ejecutivo caiga en Comisión de Permanencia durante su ejercicio.
		...
		\begin{art}\label{requisitosCAPostegrado}
			...
			\begin{enumerate}
				\item Ser alumno regular o en vías de grado de Postgrado.
