	...
	\section{Funcionamiento y apartados}
		...
		\subsection*{Sobre el Tribunal Calificador de Elecciones}
			...
			\begin{art}\label{definicionTRICEL}
				El Tribunal Calificador de Elecciones, en adelante TRICEL, será el organismo encargado de implementar y supervisar todo proceso eleccionario o de sufragio universal a nivel de CAi. Se regirá por un Apartado propio denominado ''Reglamento TRICEL CAi'', en el cual se especifican sus funciones y atribuciones durante los sufragios. En caso de elecciones de modalidad electrónica, se añadirá en el apartado una sección de “Reglas Técnicas en Elecciones Online”, donde se especifican consideraciones y requisitos propios del proceso. El TRICEL tendrá carácter temporal, cumpliendo sus funciones sólo respecto del proceso eleccionario para el cual se constituye. Se conformará en el siguiente momento:
				\begin{enumerate}
	...
	\section{Reformas}\label{reformas}
		...
		\begin{art}\label{normaReforma}
			...
			\begin{enumerate}
				...
				\item  En caso de ser los Estatutos principales, requerirá acuerdo de a lo menos dos tercios del total de los votos posibles del Consejo Académico y también del Consejo Generacional, independiente de ausencias o presencias. Adicionalmente, podrá votarse un cambio de estatuto, con un máximo de 3 mociones, mediante un plebiscito a realizarse junto con la elección de representantes CAi y Consejería Académica, con previa aprobación de la mayoría absoluta del total de los votos posibles del Consejo Académico y del Consejo Generacional. 
				Una vez plebiscitado, el cambio de estatuto requerirá mayoría simple para ser aprobado. Estas reformas entrarán en vigencia a partir del primer día hábil del semestre académico siguiente a la publicación de ésta.
