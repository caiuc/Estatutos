	...
	\begin{enumerate}
		...
		\item Tratándose del Consejo Académico:
		      \begin{itemize}
			      ...
			      \item La Jefatura de Docencia del Comité Ejecutivo tendrá un voto.
			      ...
			      \item La Subconsejería Académica tendrá un voto en caso que la Jafatura de Docencia no esté presente.
			      \item Las personas representantes de postgrado en su conjunto tendrán 3 votos, en ningún caso se podrá acumular más de un voto por representante.
		      \end{itemize}
